...
# -----------------------------------------------------------------------------------------------------------------------------
    ...
    def change_tool(self, tool):
        self.respond("change_tool " + str(tool + 1) + " number of changes: " + str(self.Filament_Changes) + " use_filament_caching: " + str(self.use_filament_caching))
